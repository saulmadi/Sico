...
#Region "Metodos"
    ...
    Protected Overridable Sub Guardar()
        Try
            Dim val As New Validador()
            Dim flag As Boolean = True
            If Me.TablaTipo.Id > 0 Then
                Select Case _
                    MessageBox.Show ( _
                        "Es seguro de modificar el/la " + _Nombre.Nombre.ToLower + " " + Me.TablaTipo.descripcion + "?", _
            ...
            If val.PermitirIngresar And flag Then
                ...
                PanelAccion.lblEstado.Text = Me._Nombre.Nombre + " " + Me.TablaTipo.descripcion + _
                                             " guardado(a) correctamente."
...
#Region "Eventos"
    ...
    Private Sub crtTablaTipo_Load (ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
