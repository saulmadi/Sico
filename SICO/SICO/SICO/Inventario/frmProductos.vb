        ...
        Set (ByVal value As Productos)
            ...
            Else
                ...
                Try
                    ...
                    End If
                Catch ex As Exception
                    MessageBox.Show ("Error en la configuración. Debe de configurar la sucursal en la que se encuentra", _
...
#Region "Eventos"
    ...
    Private Sub frmProductos_Load (ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PanelAccion1_Guardar() Handles PanelAccion1.Guardar
        Try
            ...
            If Me.Producto.Id > 0 Then
                Select Case _
                    MessageBox.Show ("¿Desea modificar el producto " + Producto.Descripcion + "?", "Confirmación", _
            ...
            If flag Then
                ...
                If vali.PermitirIngresar Then
                    ...
                    If txtcantidainventario.Enabled Then
                        ...
                        Catch ex As Exception
                            MessageBox.Show ( _
                                "Error en la configuración. Debe de configurar la sucursal en la que se encuentra", _
                                "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                        End Try
    ...
    Private Sub btnModificar_Click (ByVal sender As Object, ByVal e As EventArgs) Handles btnModificar.Click
        If _
            MessageBox.Show ( _
                "¿Desea cambiar la cántidad en inventario para la sucursal?, esta cántidad aumenta automaticamente con las compras.", _
    ...
    Private Sub Button1_Click (ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        Try
            ...
            lisata.Add (New Parametro ("fechacompra", _
                                       " fechacompra >= '" + dteFecha.Value.ToString ("yyyy-MM-dd") + _
                                       "' and fechacompra <= '" + dteFechahasta.Value.ToString ("yyyy-MM-dd") + "' "))
