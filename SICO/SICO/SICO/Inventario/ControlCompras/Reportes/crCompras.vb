...
Public Class crCompras
    ...
    <Browsable (false), _
        DesignerSerializationVisibilityAttribute (DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property Parameter_idcompras() As IParameterField
        Get
...
Public Class CachedcrCompras
    ...
    Public Overridable Function CreateReport() As ReportDocument Implements ICachedReport.CreateReport
        Dim rpt As crCompras = New crCompras
        rpt.Site = Me.Site
        Return rpt
    End Function
