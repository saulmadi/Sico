...
#Region "Eventos"
    ...
    Private Sub PanelAccion1_Imprimir() Handles PanelAccion1.Imprimir
        Try
            ...
            re.Subreports("crProveedor.rpt").DataDefinition.FormulaFields("Proveedor").Text = "'" + Me.OrdenCompar.DescripcionProveedor + "'"
            re.Subreports("crProveedor.rpt").DataDefinition.FormulaFields("Telefono").Text = "'" + txtTelefonoProveedor.Text + "'"

            re.DataDefinition.FormulaFields("elaboradoen").Text = "'" + txtSucursal.Text + "'"
            re.DataDefinition.FormulaFields("Fecha").Text = "'" + Me.OrdenCompar.fechaorden.ToString("dd/MM/yyyy") + "'"
