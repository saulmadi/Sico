...
Public Class frmBusquedaCompras
    ...
    Private Sub frmBusquedaCompras_Load (ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    Public Sub Cargar()
        Try
            ...
            p.Add (New Parametro ("fechacompra", _
                                  " fechacompra >= '" + fecha.Value.ToString ("yyyy-MM-dd") + "' and fechacompra <= '" + _
