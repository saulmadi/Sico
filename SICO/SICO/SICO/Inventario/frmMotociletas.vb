...
#Region "Eventos"
    ...
    Private Sub frmMotociletas_Load (ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        cmbTipoMotocicleta.ColeccionParametros.Add (New ListaDesplegable.ParametrosListaDesplegable ("habilitado", "1"))
