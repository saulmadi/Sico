...
Public Class crEstadoCuenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SICO.crEstadoCuenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEstadoCuenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEstadoCuenta = New crEstadoCuenta
        rpt.Site = Me.Site
        Return rpt
    End Function
