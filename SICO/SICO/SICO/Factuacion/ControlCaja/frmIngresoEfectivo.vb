...
Public Class frmIngresoEfectivo
    ...
    Private Sub frmIngresoEfectivo_Load (ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub PanelAccion1_Guardar() Handles PanelAccion1.Guardar
        Try
            ...
            If f.Autorizo Then
                If _
                    MessageBox.Show ("¿Esta seguro de ingresar este efectivo?", "Advertencia", MessageBoxButtons.YesNo) = _
                    ...
                    If txtEfectivo.Text <> String.Empty Then
                        If _controlCaja.AperturaCaja (PanelAccion1.Usuario.Id, dteFecha.Value, "") Then
                            ...
                            _controlCaja.RealizarIngresoEfectivo (Me.PanelAccion1.Usuario.Id, txtEfectivo.Text, _
                                                                  dteFecha.Value, PanelAccion1.sucursal.Id, _
                                                                  Me.PanelAccion1.Usuario)
                            MessageBox.Show ("Se ingreso correctamente el efectivo", "Información", MessageBoxButtons.OK, _
                                             MessageBoxIcon.Information)
                            Me.Close()
                        End If
