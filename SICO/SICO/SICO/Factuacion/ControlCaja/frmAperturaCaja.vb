...
Public Class frmAperturaCaja
    ...
    Private Sub PanelAccion1_Guardar() Handles PanelAccion1.Guardar
        Try
            ...
            If f.Autorizo Then
                If _
                    MessageBox.Show ("¿Esta seguro de abrir la caja?", "Advertencia", MessageBoxButtons.YesNo) = _
                    ...
                    If txtEfectivo.Text <> String.Empty Then
                        If Not _controlCaja.AperturaCaja (PanelAccion1.Usuario.Id, dteFecha.Value, "") Then
                            ...
                            _controlCaja.RealizarApertura (Me.PanelAccion1.Usuario.Id, txtEfectivo.Text, dteFecha.Value, _
                                                           PanelAccion1.sucursal.Id, Me.PanelAccion1.Usuario)
                            MessageBox.Show ("Se aperturó correctamente la caja", "Información", MessageBoxButtons.OK, _
