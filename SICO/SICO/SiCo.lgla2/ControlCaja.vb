...
#Region "Constructor"
    ...
    Public Sub New (ByVal id As Long, ByVal idtransccionescaja As Long, ByVal idsucursales As Long, _
                    ByVal monto As Decimal, ByVal fecha As DateTime, ByVal cajero As Long, ByVal descripcion As String)
        Me.New()
        Me._Id = id
...
#Region "Metodos"
    ...
    Public Overrides Function TablaAColeccion() As Object
        ...
        For i As Integer = 0 To Me.TotalRegistros - 1
            ...
            Dim tempControl = New ControlCaja (Me.Id, Me.idTransaccionesCaja, Me.idSucursales, Me.Monto, Me.Fecha, _
                                               Me.Cajero, Me.Descripcion)
            lista.Add (tempControl)
        Next
        Return lista
    End Function

    Public Sub IngresarTransaccion (ByVal idtransaccion As Long, ByVal idsucursal As Long, ByVal monto As Decimal, _
                                    ByVal fecha As DateTime, ByVal cajero As Long, ByVal descripcion As String)
        Try
    ...
    Public Overloads Sub Buscar (ByVal idtransaccion As String, ByVal cajero As Long, ByVal fecha As DateTime, _
    ...
    Public Function RealizarApertura (ByVal cajero As Long, ByVal monto As Decimal, ByVal fecha As DateTime, _
                                      ByVal sucursal As Long, ByVal usuario As Usuario)
        Try
            Me.IniciarTransaccion()
            Me.IngresarTransaccion (4, sucursal, monto, fecha, cajero, _
                                    "Apertura de caja para el usuario " + usuario.NombreUsuario)
    ...
    Public Function RealizarIngresoEfectivo (ByVal cajero As Long, ByVal monto As Decimal, ByVal fecha As DateTime, _
                                             ByVal sucursal As Long, ByVal usuario As Usuario)
        Try
            Me.IniciarTransaccion()
            Me.IngresarTransaccion (7, sucursal, monto, fecha, cajero, _
                                    "Se ingreso efectivo para el usuario " + usuario.NombreUsuario)
            Me.CommitTransaccion()
            Return True
        Catch ex As Exception
            Me.RollBackTransaccion()
    ...
    Public Function RealizarRetiroEfectivo (ByVal cajero As Long, ByVal monto As Decimal, ByVal fecha As DateTime, _
                                            ByVal sucursal As Long, ByVal usuario As Usuario, _
