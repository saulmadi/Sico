...
#Region "Constructor"
    ...
    Public Sub New (ByVal id As Long, ByVal facturacompra As Long, ByVal idsucursal As Long, ByVal idproveedor As Long, _
                    ByVal fechacompra As Date, ByVal totalcompra As Decimal, ByVal Proveedor As Proveedores)
        Me.New()
        Me._Id = id
...
#Region "Metodos"
    ...
    Protected Overrides Sub CargadoPropiedades (ByVal Indice As Integer)
        ...
        _proveedor = New Proveedores (Registro (Indice, "idproveedor"), Registro (Indice, "identidades"), _
                                      Registro (Indice, "estadoproveedor"), Registro (Indice, "idcontacto"), _
    ...
    Public Overrides Function TablaAColeccion() As Object
        ...
        For i As Integer = 0 To Me.TotalRegistros - 1
            ...
            Dim _
                tempC As _
                    New Compras (Me.Id, Me.facturacompra, Me.idsucursal, Me.idproveedor, Me.fechacompra, Me.totalcompra, _
                                 Me.Proveedor)
        ...
        Try
            ...
            For Each i In _diccionario
                If i.Value.idproducto > 0 Then
                    ...
                    Else
                        Throw _
                            New ApplicationException ("La cantidad o el precio de compra de un producto no puede ser 0")
                    End If
                End If
