...
#Region "Construtor"
    ...
    Public Sub New()
        ...
        Me.ColeccionParametrosMantenimiento.Add (New Parametro ("codigoCuentaCorriente", "", _
    ...
    Public Overloads Sub Guardar (ByVal identidad As Long, ByVal idtipomonto As Integer, ByVal fechavencimiento As Date, _
                                  ByVal monto As Decimal, ByVal descripcion As String, ByVal idrubro As Integer, _
