...
{ 
    ...
    public static class EntityServicioMantenimientoHelper 
    {
         ...
         public static THijo ToEntidadServicioMantenimientoHijo<THijo, TPadre>(this IEntiMantenimientosClomplejosHijos mantenimientos)
        ...
        public static IList<THijo> ToListOfEntidadMantenimientoHijo<THijo,TPadre, TEntiM>(this ICollection<TEntiM> mantenimientos)
            where THijo : IEntidadServicioMantenimientoHijo<TPadre>, new()
            where TEntiM : IEntiMantenimientosClomplejosHijos 
            where TPadre : IEntidadServicioMantenimiento, new()
        {

            return mantenimientos.Select(entiMantenimientose => ToEntidadServicioMantenimientoHijo<THijo,TPadre>(entiMantenimientose))
                                        .ToList();
        }
